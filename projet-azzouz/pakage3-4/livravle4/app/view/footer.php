<footer class="footer">
    ...
    <div class="box-container" style="max-width: 1110px; margin: auto; padding: 16px;border-radius: 18px;">
    ...
    <script src="<?= PUBLIQUE ?>/asset/script/script.js"></script>
    <script src="<?= PUBLIQUE ?>/asset/script/modal.js"></script>
    <script src="<?= PUBLIQUE ?>/asset/script/favoritDisplay.js"></script>
