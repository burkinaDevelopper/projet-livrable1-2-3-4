...
<body>
                ...
                <div class="main_navbar position-sticky">
                    ...
                    <form class="social_icons" role="search">
                        ...
                        <?php if (!isset($_SESSION['login'])) : ?>
                            <a href="<?= URL ?>login"><i class="bi bi-person-circle"></i></a>
                        <?php else : ?>
    ...
    <div class="nav_bottom_row" id="banner">
        <div class="container">
            <ul>
                <li>
    ...
    <main>
        <section class="banner" id="<?= $bannner ? "baner" : "" ?>">
            <div class="container" id="slide">
                <?php if (isset($slide)) : ?>
                    <h2><?= $slide['title'] ?></h2>
                    <div class="row d-flex justify-content-center slide-container">
                        <img src="<?= URL ?>public/asset/media/<?= $slide['image'] ?>" alt="">
                    </div>
                <?php endif ?>
            </div>
            <form action="<?= URL ?>serach" method="post" class="form-search">
                <input type="text" name="query" placeholder="rechercher articles">
